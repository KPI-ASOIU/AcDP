	...
	describe "POST #create" do
		...
		context "with valid message attributes" do 
			it "creates a new conversation" do 
				expect{ 
					post :create, conversation: @conversation_attr, sender_id: @current_user.id, receivers_ids: [@user.id], modal_title: I18n.t('messages.new'), message: @message_attr
		...
		context "with invalid message attributes" do 
			it "doesn't save message" do
				expect{ 
					post :create, conversation: @conversation_attr, sender_id: @current_user.id, receivers_ids: [@user.id], modal_title: I18n.t('messages.new'), message: @message_invalid_attr
