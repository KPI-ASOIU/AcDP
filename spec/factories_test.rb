# Test your FactoryGirl actories with rspec
# just run the following to test all factories:
#
# rspec spec/factories_test.rb
#
# NOTE: you must be in the rails project folder
